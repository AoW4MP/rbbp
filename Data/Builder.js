...
const errorImage = "/rbbp/Icons/Text/exclamationpoint.png";
...
function ShowUnitFromLink() {
    ...
    document.title = "Age of Wonders 4 RbbP - " + unitNameLoc.name;
...
function addUnitTypeIcon(a, holder, origin) {
    ...
    if (origin !== "") {
        ...
        if (roleNames.includes(iconName)) {
            ...
            unitRole.setAttribute("src", `/rbbp/Icons/Text/${clearname}.png`);
        }
    }
...
function addAbilityslot(a, holder, list, enchant, uniqueMedal) {
    ...
    if (Melee != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/rbbp/Icons/Text/armor_small.png");
    ...
    if (Magic != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/rbbp/Icons/Text/resistance_small.png");
...
function GetAbilityToolTip(ability, uniqueMedal) {
    ...
    abilityIcon.setAttribute("src", "/rbbp/Icons/UnitIcons/" + ability.icon + ".png");
    abilityIcon.style.backgroundImage = "url(/rbbp/Icons/Interface/" + abilityBackground + ".png";
...
function CreatePassiveSlotToolTip(abilityIcon, abilityName, abilityDescr) {
    ...
    spa.innerHTML =
        '<div class="abilityHighLighter"><img style="float:left; position:relative; top:-7px; height:30px; width:30px" src="/rbbp/Icons/UnitIcons/' +
        abilityIcon +
...
function addResistanceSlot(a, resistance, defense, holder) {
    ...
    if (a.indexOf("Physical") !== -1) {
        imag.setAttribute("src", "/rbbp/Icons/Text/physical_resistance.png");
...
function showUnit(unitID, subcultureCheck, resID, divOrigin) {
    ...
    imagelink.setAttribute("src", "/rbbp/PreviewsAvif/" + unitEN.id + ".avif");
    ...
    if ("combat_speed" in unitEN) {
        ...
        img.setAttribute("src", "/rbbp/Icons/Text/combat_speed.png");
...
function backtrackUnitOrigins(unitData, name, holder) {
    ...
    for (let x = 0; x < tomes.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/TomeIcons/${tomes[x].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?tome=${tomes[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < spells.length; x++) {
        ...
        // const imgSrc = `/rbbp/Icons/SpellIcons/${imageLinkName}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
    ...
    for (let x = 0; x < siege.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/SiegeProjectIcons/${siege[x].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?siege=${siege[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < struc.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/UpgradeIcons/${struc[x].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?structure=${struc[x].id}`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
    ...
    for (let x = 0; x < traitFound.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/FactionCreation/${traitFound[x].id}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?trait=${traitFound[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < wonder.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/StructurePics/${wonder[x].id}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?wonder=${wonder[x].id}`;
    ...
    for (let x = 0; x < tree.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/EmpireProgressionIcons/${tree[x].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
    ...
    for (let x = 0; x < unitAbility.length; x++) {
        ...
        const imgSrc =
            unitAbility[0] != ""
                ? `/rbbp/Icons/UnitIcons/${unitAbility[x][1].icon}.png`
                : `/rbbp/Icons/UnitIcons/${unitAbility[x][1].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Units.html?unit=${unitAbility[x][0].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < infusion.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/UnitIcons/` + infusion[x].icon + `.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Infusions.html`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
    ...
    for (let x = 0; x < heroSkill.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/UnitIcons/${heroSkill[x].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?skill=${heroSkill[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < governance.length; x++) {
        ...
        const imgSrc = `/rbbp/Icons/GovernanceIcons/${governance[x].icon}.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/Spells.html?governance=${governance[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (evolve != "") {
        ...
        const imgSrc = `/rbbp/Icons/Text/evolve.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
    ...
    if (freecity.length > 0) {
        ...
        const imgSrc = `/rbbp/Icons/Text/free_city.png`;
        const imgFallbackSrc = `/rbbp/Icons/Text/mp.png`;
        const link = `/rbbp/HTML/FreeCities.html`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
        miniIcon.innerHTML = "<rally></rally>";
...
function addLevelUpInfo(units, a, holder) {
    ...
    if (evolveTarget) {
        const levelText = `<bullet> Evolves/Promotes into <hyperlink><a href="/rbbp/HTML/Units.html?unit=${evolveTarget}" target="_blank">${lookupUnit(evolveTarget)}</a></hyperlink></bullet>`;
...
function showSiegeProject(id, showOrigin, divOrigin) {
    ...
    populateGenericCard(divOrigin, {
        ...
        icon: "/rbbp/Icons/SiegeProjectIcons/" + siegeProject.icon + ".png"
    });
...
function showEmpireUpgrade(skill, showOrigin, divOrigin) {
    ...
    let imageLinkName = skill.name.replaceAll(" ", "_").toLowerCase();
    imagelink.setAttribute("src", "/rbbp/Icons/ExtraIcons/" + imageLinkName + ".png");
...
function showTome(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/rbbp/Icons/TomeIcons/" + tomeEN.icon + ".png");
...
function showStructure(a, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/rbbp/Icons/UpgradeIcons/" + structureLoc.icon + ".png");
...
function showRelic(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/rbbp/Icons/RelicIcons/" + relic.icon + ".png");
...
function showWorldStructure(a, divOrigin) {
    ...
    if (structure.type.indexOf("wonder") != -1) {
        ...
        imagelink.setAttribute("src", "/rbbp/Icons/Text/landmark.png");

        imagelink.setAttribute("style", "background-image: none");
    } else if (structure.type == "Spawner") {
        imagelink.setAttribute("src", "/rbbp/Icons/Interface/Header/Infestation.png");
        imagelink.setAttribute("style", "background-image: none");
    } else {
...
function showInfusionListEntrySmall(infusion, selectedTreeFilter, selectedSubTreeFilter, selectedMMTreeFilter) {
    ...
    icon.setAttribute("src", "/rbbp/Icons/UnitIcons/" + infusion.icon + ".png");
    ...
    for (const entry of weapons) {
        ...
        const img = document.createElement("img");
        img.setAttribute("src", "/rbbp/Icons/ItemForge/" + entry.toLowerCase() + ".png");
...
function showDestinyTrait(trait, divOrigin) {
    ...
    if (traitEN != undefined) {
        ...
        imagelink.setAttribute("src", "/rbbp/Icons/EmpireProgressionIcons/" + traitEN.id + ".png");
...
function showEmpireTree(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/rbbp/Icons/EmpireProgressionIcons/" + treeEntry.icon + ".png");
...
function showUnitUnlock(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/rbbp/Icons/UnitUnlockIcons/" + a.unit_slug + ".png");
...
function showItem(itemLoc, divOrigin) {
    ...
    tomeOriginIcon.setAttribute("src", "/rbbp/Icons/UnitIcons/" + itemLoc.icon + ".png");
}
...
function showTraitSetup(currentTrait, divOrigin, loc) {
    ...
    if ("extraLookup" in currentTrait || iconLink == undefined) {
        ...
        imagelink.setAttribute("src", "/rbbp/Icons/TraitIcons/" + iconLink + ".png");
    }
    ...
    for (const entry of thisFreeCityPart) {
        ...
        if ("enchantments" in entry) {
            ...
            for (const unit of entries) {
                ...
                div.setAttribute("style", "margin-right: 20px;");
                div.innerHTML =
                    '<a href="/rbbp/HTML/Spells.html?spell=' +
                    unit +
                    '" target="_blank">' +
        ...
        if ("buildings" in entry) {
            ...
            for (const unit of entries) {
                ...
                div.setAttribute("style", "margin-right: 20px;");
                div.innerHTML =
                    '<a href="/rbbp/HTML/Spells.html?structure=' +
                    unit +
                    '" target="_blank">' +
...
function showHeroGov(data, check, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/rbbp/Icons/GovernanceIcons/" + thisGovernance.icon + ".png");
    imagelink.setAttribute("style", "background-image:none");
    found = true;
}
...
function backtraceTomeOriginAndTier(spell, showorigin, modCard) {
    ...
    if (tomespells != undefined) {
        if (showorigin) {
            ...
            tomeOriginIcon.setAttribute("src", "/rbbp/Icons/TomeIcons/" + tomespells.icon + ".png");
            const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML =
                '<a href="/rbbp/HTML/Spells.html?tome=' + tomespells.id + '" target="_blank">' + wrap + "</a>";
    ...
    if (artifactSpells != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/rbbp/Icons/RelicIcons/" + artifactSpells.icon + ".png");
            const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML = '<a href="/rbbp/HTML/Artifacts.html">' + wrap + "</a>";
    ...
    if (worldStructureSpells != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/rbbp/Icons/StructurePics/" + worldStructureSpells.id + ".png");
            const wrap = tomeOriginName.innerHTML;
             if(worldStructureSpells.type == "Landmark"){
                   tomeOriginName.innerHTML = '<a href="/rbbp/HTML/Landmarks.html">' + wrap + "</a>";
            } else{
                     tomeOriginName.innerHTML = '<a href="/rbbp/HTML/AncientWonders.html">' + wrap + "</a>";
            }
    ...
    if (worldStructureSpellsReward != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/rbbp/Icons/StructurePics/" + worldStructureSpellsReward.id + ".png");
            const wrap = tomeOriginName.innerHTML;
             if(worldStructureSpellsReward.type == "Landmark"){
                   tomeOriginName.innerHTML = '<a href="/rbbp/HTML/Landmarks.html">' + wrap + "</a>";
            } else{
  ...
  let ascendedSpellsName = findBy(jsonHeroSkills, "id",  ascendedSpells.id);
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/rbbp/Icons/UnitIcons/" + ascendedSpellsName.icon + ".png");
             const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML =
                '<a href="/rbbp/HTML/HeroSkills.html">' + wrap + "</a>";
    ...
    if (ExtraSpellsLookup != undefined) {
        if (showorigin) {
            ...
            const tomeOriginIcon = modCard.querySelector("#originTomeIcon");
            tomeOriginIcon.setAttribute("src", "/rbbp/Icons/" + ExtraSpellsLookup.icon + ".png");
            // const wrap = tomeOriginName.innerHTML;
            // tomeOriginName.innerHTML =
            //     '<a href="/rbbp/HTML/Landmarks.html">' + wrap + "</a>";
